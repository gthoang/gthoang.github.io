...
}catch(d){}}(function(e){e.WCM=e.WCM||{};
e.WCM.Image=e.WCM.Image||function(){var g={};
var f={MAP_SELECTOR:".cq-wcm-foundation-image-map"};
g.handleResize=function(){var h=document.querySelectorAll(f.MAP_SELECTOR);
Array.prototype.forEach.call(h,function(l){if(!l.getAttribute("usemap")){return
...
$(document).ready(function(){$(".offer-cta").click(a);
function a(){var k=$(".offer-body").children().attr("class").replace("offer-content ","");
if(k==="ic"||k==="pdp"){var f=$("#modalTitle").val();
var q='<div class="offer-modal"></div>';
var e='<div class="modal-dialog"></div>';
var p='<div class="modal" id="'+f+'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false"></div>';
var c='<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="close();">×</button><h3>'+f+"</h3></div>";
var o='<div class="modal-body"></div>';
var r='<div class="modal-backdrop"></div>';
var n=$(".offer-cta").parent();
var m=$(p).append($(c)).append($(o));
var b=$(e).append(m).append($(r));
var g=$(q).append(b);
$(".offer-text").append(g);
var h=$(".offer-text").find(".close");
h.click(function(){l()
});
$(".modal-backdrop").click(function(){l()
});
function l(){$(".offer-modal").remove()
}}if(k==="cart-overlay"){var d=$(".offer-content").find(".displayCartOverlay").length!==0;
if(!d){var j='<div class="displayCartOverlay"></div>';
$(".offer-content").append($(j));
$(".offer-content").find(".dynamic-offer .offer-text .offer-cta").addClass("no-before")
}else{$(".offer-content .displayCartOverlay").remove();
$(".offer-content").find(".dynamic-offer .offer-text .offer-cta").removeClass("no-before")
}}}});
$(document).ready(function(){var c=$(".xf-preview");
var b=c.find(".experience_fragments.offer-content");
var d;
var a;
$.each(b,function(f,e){d=$(e).find("input[name=look-and-feel]").val();
a=$(e).attr("class").split(" ");
if(a[2]!=d&&a[2]!="cart-overlay"){a[2]=d;
$(e).removeClass();
$(e).addClass(a.join(" "))
}})
});
